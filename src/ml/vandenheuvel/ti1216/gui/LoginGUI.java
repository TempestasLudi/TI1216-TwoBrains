...
{	
	...
	public static void display()
	{
		...
		{
			/**
			 * Fetches the inputs from nameInput and passInput and checks if the credentials are in the database already.
			 */
			 @Override
		...
		/**
		 * Hyperlink to go to the RegisterGUI window when you are not a member yet.
		 */
