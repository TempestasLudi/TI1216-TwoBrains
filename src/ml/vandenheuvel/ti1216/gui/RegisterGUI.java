...
public class RegisterGUI 
{
	...
	public static void display()
	{
		...
		{
			/**
			 * Fetches the input from all the textfields above and puts them into the database as a new user.
			 */
			 @Override
		 ...
		 */
		grid.getChildren().addAll(nameLabel, nameInput, passLabel1, passInput1, passLabel2, passInput2, postalLabel, postalInput, descriptionLabel, descriptionInput, courseIDLabel, courseIDInput, gradeLabel, gradeInput, gradeValue, loginButton);
