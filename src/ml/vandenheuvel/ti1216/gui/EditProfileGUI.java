...
public class EditProfileGUI {
	...
	public static void display(){
		...
		{
			/**
			 * Fetches the input from all the text fields above and puts them into the database as an updated user.
			 */
			 @Override
		 ...
		 */
		grid.getChildren().addAll(textLabel, nameLabel, nameInput, passLabel1, passInput1, passLabel2, passInput2, postalLabel, postalInput, descriptionLabel, descriptionInput, courseIDLabel, courseIDInput, gradeLabel, gradeInput, updateButton);
