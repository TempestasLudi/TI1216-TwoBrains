...
public class MatchTest 
{
	...
	{
		Match test1 = new Match("username1", "username2");
		Match test2 = new Match("username1", "username2");
	...
	{
		Match test1 = new Match("username2", "username1");
		Match test2 = new Match("username1", "username2");
		assertTrue(test1.equals(test2));
	}
	...
	{
		Match test1 = new Match("username1", "username2");
		Match test2 = new Match("username1", "username1");
	...
	{
		Match test1 = new Match("username2", "username2");
		Match test2 = new Match("username1", "username1");
		assertFalse(test1.equals(test2));
	}
}
